...
```
From the Table\@ref(tab:Suicide-Number-of-Different-Age), we can find that the number of suicides presents different characteristics according to different age groups. Those aged 35 to 54 had the highest number of suicides, while those aged 5-14 had the least.
...
```
From Figure\@ref(fig:Suicide-Number-of-Different-Age), we can see that the number of suicides increased rapidly from 1985 to 2000, and then stabilized and fluctuated after 2000.
...
```
Figure\@ref(fig:average-suicide-number-per-age-over-the-years), the average number of suicides in each age group is relatively stable and shows significant differences. The youngest and oldest groups had the lowest total suicides, while the 35-54 and 55-75-year-olds had the highest average suicide rates.
